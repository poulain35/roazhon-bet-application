...
import { getMailsState } from 'app/apps/mail-ngrx/store/selectors';
import * as MailsActions from 'app/apps/mail-ngrx/store/actions/mails.actions';
import * as fromRoot from 'app/store';

import { Mail } from 'app/apps/mail-ngrx/mail.model';
...
export class MailsEffect {
   ...
   */
  @Effect()
  updateMail: Observable<{}> = this.actions.pipe(
