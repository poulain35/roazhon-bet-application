...
import { FusePipesModule } from 'app/@fuse/pipes/pipes.module';

import { FuseMaterialColorPickerComponent } from 'app/@fuse/components/material-color-picker/material-color-picker.component';
